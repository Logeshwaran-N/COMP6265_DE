...
CATALOGUE: Dict[str, Dict[str, Any]] = {
    ...
    "fx_rates": {
        ...
        "entity_key": "pair",
        "columns": {
            "pair": {"type": "string", "pii": False, "price": 1.0, "distinct": 5, "meaning": "Currency pair such as GBP_INR"},
            "rate": {"type": "number", "pii": False, "price": 3.0, "distinct": 20, "meaning": "Exchange rate"},
            "precision": {"type": "number", "pii": False, "price": 1.0, "distinct": 5, "meaning": "Decimal precision supplied by provider"},
            "last_updated": {"type": "date", "pii": False, "price": 1.0, "distinct": 10, "meaning": "Timestamp of the rate"},
        },
        "price_points": [
...
PROVIDER_ENDORSEMENTS = {
    "gov_authorised_server": ["enterprise_warehouse", "realtime_fx_provider"],
    ...
    "realtime_fx_provider": ["gov_authorised_server"],
